...
<!-- PRESENTATION Hébergeur ============================================================== -->
  <main>
      <section>
               <p>Ce site vous présente l'hébergeur Gandi.net ! Retrouvez les statistiques complètes du temps de chargement de pages hébergées sur gandi.net, et utilisez notre formulaire pour poser toutes vos questions sur ses offres d'hébergement.</p>
      </section>
      <section><h2>Informations sur mon hébergeur</h2>
               <p><strong>Nom : </strong> OVH</p>
               <p><strong>Logo : </strong> <img src="img/gandi.jpg" alt="Logo de gandi.net"/></p>
               <p><strong>Siège social : </strong> 2 rue Kellermann - 59100 Roubaix - France</p>
               <p><strong>Lien d'inscription : </strong>
               <a href="https://www.ovh.com/fr/" target="_blanck" >Inscription OVH</a></p>
      </section>
      <section><h2>Informations sur la page question.php</h2>
               <p><strong>Temps de chargement total en ms( https://tools.pingdom.com/ ): </strong> 649 ms</p>
